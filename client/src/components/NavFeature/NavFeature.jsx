...
const NavFeature = ({ feature, changeFeature, logout }) => {
    useEffect(() => {
        document.querySelectorAll('.feature').forEach(feature => {
            feature.addEventListener("click", (e) => {
                e.preventDefault();
                changeFeature(e.currentTarget.dataset.feature);
            })
        })
    }, [])
    let toggleMenuUser = (e) => {
    ...
    return (
        <div className="navFeature">
            ...
            <ul>
                <li>
                    <a href="Chat" className={feature === "Chat" ? "feature active" : "feature"} data-feature="Chat">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
                    </a >
                </li>
                <li>
                    <a href="Friend" className={feature === "Friend" ? "feature active" : "feature"} data-feature="Friend">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                    </a >
                </li>
                <li>
                    <a href="Favorite" className={feature === "Favorite" ? "feature active" : "feature"} data-feature="Favorite">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"></polygon></svg>
                    </a >
                </li>
                <li>
                    <a href="Attach" className={feature === "Attach" ? "feature active" : "feature"} data-feature="Attach">
